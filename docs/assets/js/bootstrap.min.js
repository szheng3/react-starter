...
if (typeof jQuery === 'undefined') throw new Error("Bootstrap's JavaScript requires jQuery"); +(function (a) {
  ...
  function b() {
    ...
    let c = !1,
      d = this; a(this).one('bsTransitionEnd', () => { c = !0; }); const e = function () { c || a(d).trigger(a.support.transition.end); }; return setTimeout(e, b), this;
  }, a(() => { a.support.transition = b(), a.support.transition && (a.event.special.bsTransitionEnd = { bindType: a.support.transition.end, delegateType: a.support.transition.end, handle(b) { if (a(b.target).is(this)) return b.handleObj.handler.apply(this, arguments); } }); });
}(jQuery)), +(function (a) {
  function b(b) {
  ...
  function b(b) {
  ...
  } var c = function (b, c) { this.$element = a(b), this.$indicators = this.$element.find('.carousel-indicators'), this.options = c, this.paused = null, this.sliding = null, this.interval = null, this.$active = null, this.$items = null, this.options.keyboard && this.$element.on('keydown.bs.carousel', a.proxy(this.keydown, this)), this.options.pause == 'hover' && !('ontouchstart' in document.documentElement) && this.$element.on('mouseenter.bs.carousel', a.proxy(this.pause, this)).on('mouseleave.bs.carousel', a.proxy(this.cycle, this)); }; c.VERSION = '3.3.7', c.TRANSITION_DURATION = 600, c.DEFAULTS = {
    ...
    let b = this,
      c = this.getItemIndex(this.$active = this.$element.find('.item.active')); if (!(a > this.$items.length - 1 || a < 0)) return this.sliding ? this.$element.one('slid.bs.carousel', () => { b.to(a); }) : c == a ? this.pause().cycle() : this.slide(a > c ? 'next' : 'prev', this.$items.eq(a));
  ...
  }; a(document).on('click.bs.carousel.data-api', '[data-slide]', e).on('click.bs.carousel.data-api', '[data-slide-to]', e), a(window).on('load', () => { a('[data-ride="carousel"]').each(function () { const c = a(this); b.call(c, c.data()); }); });
}(jQuery)), +(function (a) {
  function b(b) {
    let c,
  ...
  }; const h = a.fn.dropdown; a.fn.dropdown = d, a.fn.dropdown.Constructor = g, a.fn.dropdown.noConflict = function () { return a.fn.dropdown = h, this; }, a(document).on('click.bs.dropdown.data-api', c).on('click.bs.dropdown.data-api', '.dropdown form', a => { a.stopPropagation(); }).on('click.bs.dropdown.data-api', f, g.prototype.toggle)
  ...
  function b(b) {
  ...
  } var c = function (a, b) { this.type = null, this.options = null, this.enabled = null, this.timeout = null, this.hoverState = null, this.$element = null, this.inState = null, this.init('tooltip', a, b); }; c.VERSION = '3.3.7', c.TRANSITION_DURATION = 150, c.DEFAULTS = {
    ...
    let b = {},
      c = this.getDefaults(); return this._options && a.each(this._options, (a, d) => { c[a] != d && (b[a] = d); }), b;
  ...
  function b(b) {
  ...
  } var c = function (a, b) { this.init('popover', a, b); }; if (!a.fn.tooltip) throw new Error('Popover requires tooltip.js'); c.VERSION = '3.3.7', c.DEFAULTS = a.extend({}, a.fn.tooltip.Constructor.DEFAULTS, {
    ...
    let a = this.tip(),
      b = this.getTitle(),
      c = this.getContent(); a.find('.popover-title')[this.options.html ? 'html' : 'text'](b), a.find('.popover-content').children().detach().end()
  ...
  function b(c, d) { this.$body = a(document.body), this.$scrollElement = a(a(c).is(document.body) ? window : c), this.options = a.extend({}, b.DEFAULTS, d), this.selector = `${this.options.target || ''} .nav li > a`, this.offsets = [], this.targets = [], this.activeTarget = null, this.scrollHeight = 0, this.$scrollElement.on('scroll.bs.scrollspy', a.proxy(this.process, this)), this.refresh(), this.process(); } function c(c) {
    ...
    }).sort((a, b) => a[0] - b[0]).each(function () { b.offsets.push(this[0]), b.targets.push(this[1]); });
  ...
  function b(b) {
    ...
    let b = this.element,
      ...
      let e = c.find('.active:last a'),
        ...
        g = a.Event('show.bs.tab', { relatedTarget: e[0] }); if (e.trigger(f), b.trigger(g), !g.isDefaultPrevented() && !f.isDefaultPrevented()) { const h = a(d); this.activate(b.closest('li'), c), this.activate(h, h.parent(), () => { e.trigger({ type: 'hidden.bs.tab', relatedTarget: b[0] }), b.trigger({ type: 'shown.bs.tab', relatedTarget: e[0] }); }); }
    }
  ...
  }; const d = a.fn.affix; a.fn.affix = b, a.fn.affix.Constructor = c, a.fn.affix.noConflict = function () { return a.fn.affix = d, this; }, a(window).on('load', () => {
